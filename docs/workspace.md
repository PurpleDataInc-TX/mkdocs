...
Workspace Settings in CloudPi provides centralized configuration and management of your workspace environment, including user management, role-based access control, integrations, alerts, and billing information.

---

## Overview

The Workspace Settings section is accessible from the header navigation and includes the following modules:

- **User Management** - Manage workspace and project users
- **Roles & Permissions** - Define and manage role-based access control
- **Workflow Tools Integration** - Connect with Jira and ServiceNow
- **Alerts** - Configure email, ticketing, and in-app notifications
- **Billing Information** - View and manage subscription details
